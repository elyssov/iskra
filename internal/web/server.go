...
func (s *Server) Start() error {
	...
	mux.HandleFunc("/api/panic/status", s.api.HandlePanicPinStatus)
	mux.HandleFunc("/api/panic/pin", s.api.HandlePanicPinSet)
	mux.HandleFunc("/api/backup/create", s.api.HandleBackupCreate)
